...
const Deletras =[document.getElementById('firstName'),document.getElementById('lastName')]
const nombre = document.getElementById('firstName')
const apellido = document.getElementById('lastName') 
const correo = document.getElementById('email') 
const cc = document.getElementById('documento')
...
cc.addEventListener('keypress',soloNumeros)        ;
